...
# Arg 2: Amount_of_plasmid
# Arg 3: Plasmid_used
# Arg 4: Number for DAPI minimum threshold
# Arg 5: Number for Secondary signal minimum threshold
# Arg 6: /Path/to/output_directory
# Arg 7: Macro template file
#
# Argument notes
#
...
MACROGEN=~/Immunofluorescence/Macros/MacroGen.sh
