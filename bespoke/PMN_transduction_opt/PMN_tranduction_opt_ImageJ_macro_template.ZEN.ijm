...
// Outline cells
run("Analyze Particles...", "size=2-Infinity exclude summarize add");
...
// OPEN RED-yH2AX AND OVERLAY NUCLEAR OUTLINES TO IDENTIFY CELLS WITH DNA DAMAGE SIGNAL
// Open blue channel image
...
// OPEN FAR-RED-BIII-Tub AND OVERLAY NUCLEAR OUTLINES TO IDENTIFY Nueronal Cells
// Open blue channel image
open("IMAGE/PREFIX_c4.tif")
...
// Save green image with nuclear overlay
saveAs("Tiff", "IMAGE/PREFIX_NuclearOverlay(far_red).tif");

//Save measurements made my imageJ as .csv file
saveAs("Results", "IMAGE/PREFIX_NuclearOverlay_ROI_measures(far_red).csv");
